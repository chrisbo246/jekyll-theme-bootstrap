    ...
    if ($dls.length) {
      ...
      */
      ...
      $nestedDls.each(function () {
        ...
        $dl.replaceWith('<ul id="' + validId(parentText + '_nav') + '" class="nav justify-content-end" role="tablist">' + tabsHtml + '</ul><div id="' + validId(parentText + '_content') + '" class="tab-content">' + panesHtml + '</div>');
      });
